...
export const CHAT_MODELS = ["gpt-4o", "gpt-4o-mini", "gpt-4.1", "gpt-4.1-mini"] as const;

export const createWorkspaceSchema = z.object({
    title: z.string().trim().min(1, { message: "Title is required" }).max(50, { message: "Title must be less than 50 characters" }),
    ...
    icon: z.string().trim().min(1, { message: "Icon is required" }).max(50, { message: "Icon must be less than 50 characters" }),
